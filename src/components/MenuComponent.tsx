...
const mucMenu = [
    ...
    { key: 'home-text', icon: <FileTextOutlined />, label: 'Giới thiệu', path: '/hometext' },
    ...
    { key: 'thong-tin-lien-he', icon: <ContactsOutlined />, label: 'Thông tin liên hệ', path: '/contact-info' },
